# Diamond Reports API OpenAPI Specification
[![Build Status](https://travis-ci.org/mrtyormaa/test-redoc.svg?branch=master)](https://travis-ci.org/mrtyormaa/test-redoc)
...
6. If you did everything correct, https://mrtyormaa.github.io/test-redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://mrtyormaa.github.io/test-redoc/
- Look full spec:
    + JSON https://mrtyormaa.github.io/test-redoc/swagger.json
    + YAML https://mrtyormaa.github.io/test-redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://mrtyormaa.github.io/test-redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mrtyormaa.github.io/test-redoc/ with url from the message: `Server started <url>`
